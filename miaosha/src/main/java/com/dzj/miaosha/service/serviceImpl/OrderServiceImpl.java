...
public class OrderServiceImpl implements OrderService {
	...
	public MiaoshaOrder getMiaoshaOrderByUserIdAndGoodsId(long userId, long goodsId) throws MiaoshaException {
		...
		MiaoshaOrder miaoshaOrder = redisService.get(OrderKey.getMiaoshaOrderByUserIdAndGoodsId, userId + goodsId + "",
				MiaoshaOrder.class);
	...
	public OrderInfo createOrder(User user, GoodsVo goodsVo) throws MiaoshaException {
		...
		redisService.set(OrderKey.getMiaoshaOrderByUserIdAndGoodsId, user.getUserId() + goodsVo.getGoodsId() + "",
				miaoshaOrder);
		return orderInfo;
	}
